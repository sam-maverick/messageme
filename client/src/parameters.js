...
export const PARAM_SERVER_API_URL = 'http://' + server_host + ':3000'; // Change port if needed

export const PARAM_SERVER_WS_URL = 'ws://' + server_host + ':3001'; // Change port if needed
